...
<table width="664" height="502" border="0" cellpadding="0" cellspacing="0" class="add_content">
	...
	<tr>
		...
		<td colspan="15" width="542" height="1"><input type="hidden" name="foodid" id="foodid" value="${food.foodid}">
			</td>
		<td width="1" height="1">
			</td>
	</tr>
	...
	<tr>
		<td colspan="11" rowspan="2" width="514" height="40"><input
										class="add_input1" type="text" name="price" id="price" value="${food.price }"></td>
	...
	<tr>
		<td colspan="2" rowspan="2" width="94" height="38" class="add_icon1"><input type="text" name="num" id="num" value="${food.num }"></td>
	...
	<tr>
		...
		<td colspan="11" rowspan="2" width="514" height="79"><textarea
											class="add_input2" name="descript" id="descript">${food.descript }</textarea>			</td>
		<td width="1" height="37">
			</td>
	</tr>
	<tr>
