...
.login_input_info{ width:450px; height:38px; line-height:38px; border:0px; background-color:#2eb376; font-size:24px; color:#FFFFFF; font-weight:bold}
.login_input{ width:260px; margin-left:5px; height:28px; line-height:28px; border:0px; background-color:#f1f1f1; font-size:16px;  color:#999999}
...
<table class="01" width="961" height="631" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td colspan="6" rowspan="3" width="450" height="38"><input name="textfield" type="text" class="login_input_info" value="暂无处理信息">
	  </td>
	...
	<tr>
		...
		<td colspan="5" rowspan="3" width="270" height="28"><input name="username" type="text" class="login_input" id="username">			</td>
	...
	<tr>
		<td colspan="5" width="270" height="63" rowspan="3"><input name="password" type="password" class="login_input" id="password" style="margin-top:24px;"></td>
		<td>
	...
	<tr>
		<td colspan="5" width="270" rowspan="3" height="194" style="vertical-align:top"><input name="repassword" type="text" class="login_input" id="repassword" style="margin-top:23px; ">
		<img style="margin-top:15px; margin-left:10px;" src="images/compl.png" onClick="javascript:modifypasswd()" width="180" height="44">
	  </td>
