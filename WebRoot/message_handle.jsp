...
.name{font-size:14px; position:relative; top:-13px; *top:-20px; float:left; font-weight:bold; color:#a9bfdb; line-height:22px;}
...
<table class="01" width="961" height="631" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td colspan="8" rowspan="14" width="712" height="466" style="vertical-align:top" align="left"><div class="qiu" style=" HEIGHT: 466; position:absolute; top:110px; width:712px;  vertical-align:top; ">
<ul>
<li>
