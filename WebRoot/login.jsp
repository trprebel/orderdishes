...
<table class="01" width="961" height="631" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td colspan="5" rowspan="3" width="270" height="28"><input type="text" class="login_input" name="username" id="username">			</td>
	...
	<tr>
		<td colspan="5" rowspan="2" width="270" height="29"><input type="password" class="login_input" name="password" id="password">
	  </td>
		<td>
	...
	<tr>
		...
		<td width="189" height="50" align="center"><img src="images/login.png" width="182" height="45" onClick="javascript:login()">			</td>
