	...
	<div class="main">
		...
		<div class="operating">
			...
			<div class="welcome_operating">
				<img src="<%=basePath %>${food.small_pic}" width="255" />
			</div>
			...
			<div class="list_operating0">
				<table cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width="190"><div align="left">${food.food }</div>
						</td>
					</tr>
				</table>
			</div>
			<div class="list_operating">
				<table cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width="190"><div align="left">${food.price }</div>
						</td>
					</tr>
				</table>
			</div>
			<div class="list_operating">
				<table cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width="190"><div align="left">${food.num }</div>
						</td>
					</tr>
				</table>
			</div>
				...
				<table cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width="190"><div align="left">
								<c:choose>
									<c:when test="${food.isfeature==0}">普通</c:when>
									<c:when test="${food.isfeature==1}">特色</c:when>
									<c:otherwise>特价</c:otherwise>
								</c:choose>
							</div>
						</td>
					</tr>
			...
			<div class="list_operating">
				<table cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width="190"><div align="left">${food.descript }</div>
						</td>
					</tr>
				</table>
			</div>
