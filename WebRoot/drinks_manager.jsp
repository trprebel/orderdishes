...
#position {
	...
	<body>
		...
		<div class="main">
		<form action="requestDRINKS.action" id="fromID" method="post">
			<table class="01" width="961" height="631" border="0" cellpadding="0"
				cellspacing="0">
				<tr>
					<td colspan="14" width="960" height="16">
					</td>
					<td>
						<img src="images/分隔符.gif" width="1" height="16" alt="">
					</td>
				</tr>
				<tr>
					...
					<td>
						<img src="images/分隔符.gif" width="1" height="15" alt="">
					</td>
				</tr>
				<tr>
					<td colspan="3" rowspan="3" width="960" height="53">
					</td>
					<td width="28" height="28">
						<img src="images/qu.png" width="28" height="28">
					</td>

					<td>
						<img src="images/分隔符.gif" width="1" height="28" alt="">
					</td>
				</tr>
				<tr>
					...
					<td>
						<img src="images/分隔符.gif" width="1" height="14" alt="">
					</td>
				</tr>
				<tr>
					<td rowspan="6" width="141" height="91">
					</td>
					<td>
						<img src="images/分隔符.gif" width="1" height="11" alt="">
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="4" rowspan="3" width="81" height="56">
					</td>
					<td>
						<img src="images/分隔符.gif" width="1" height="32" alt="">
					</td>
				</tr>
				<tr>
					...
					<td>
						<img src="images/分隔符.gif" width="1" height="2" alt="">
					</td>
				</tr>
				<tr>
					<td colspan="3" rowspan="2" width="208" height="42" align="center"
				...
				<tr>
					...
					<td colspan="8" rowspan="10" width="712" height="410"
						...
						<div class="qiu"
							...
							<ul>
								...
								<c:forEach var="drinks" items="${paginator.items}">
								<li>
									<div>
									...
									<div class="name">
										<span>${drinks.drinks }</span><span><img src="images/modify.png"
												width="33" height="17">
										</span>
									</div>
								</li>	
					...
					<td rowspan="14" width="10" height="466">
					</td>
				...
				<tr>
					...
					<td>
						<img src="images/分隔符.gif" width="1" height="172" alt="">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td rowspan="2" width="103" height="43" align="center">
						<input  name='paginator.currentPage' id='paginator.currentPage'   type='hidden' value='<%=paginator.getCurrentPage() %>'  />
						<a href='javascript:goPage(<%=paginator.getCurrentPage()+1 %>)'>
				...
				<tr>
					...
					<td rowspan="3" width="182" height="44" style="vertical-align: top">
						<img src="images/compl.png" width="180" height="44">
					</td>
				...
				<tr>
					...
					<td>
						<img src="images/分隔符.gif" width="1" height="1" alt="">
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<img src="images/分隔符.gif" width="27" height="1" alt="">
					</td>
					<td>
						<img src="images/分隔符.gif" width="3" height="1" alt="">
					</td>
					<td>
						<img src="images/分隔符.gif" width="29" height="1" alt="">
					</td>
					<td>
						<img src="images/分隔符.gif" width="28" height="1" alt="">
					</td>
					<td>
						<img src="images/分隔符.gif" width="21" height="1" alt="">
					</td>
					<td>
						<img src="images/分隔符.gif" width="208" height="1" alt="">
					</td>
					<td>
						<img src="images/分隔符.gif" width="182" height="1" alt="">
					</td>
					<td>
						<img src="images/分隔符.gif" width="80" height="1" alt="">
					</td>
					<td>
						<img src="images/分隔符.gif" width="141" height="1" alt="">
					</td>
					<td>
						<img src="images/分隔符.gif" width="23" height="1" alt="">
					</td>
					<td>
						<img src="images/分隔符.gif" width="10" height="1" alt="">
					</td>
					<td>
						<img src="images/分隔符.gif" width="103" height="1" alt="">
					</td>
					<td>
						<img src="images/分隔符.gif" width="2" height="1" alt="">
					</td>
					<td>
						<img src="images/分隔符.gif" width="103" height="1" alt="">
					</td>
