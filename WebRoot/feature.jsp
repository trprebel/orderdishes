...
<body>
	...
	<tr>
		<td colspan="3" width="208" height="42" align="center" class="list" onclick="location.href='specialprice.action'"><img src="images/icon6.png" width="20" height="20">今日特价&nbsp;&nbsp;</td>
